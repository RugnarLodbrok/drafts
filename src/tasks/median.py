...
if __name__ == '__main__':
    a = list(sorted(randrange(50) for _ in range(100)))
    b = list(sorted(randrange(70, 120) for _ in range(55)))
    print(f"non-intersecting:\t{median(a, b)} vs {my_median(a, b)}")
    print(f"non-intersecting:\t{median(b, a)} vs {my_median(b, a)}")

    a = list(sorted(randrange(70, 120) for _ in range(100)))
    b = list(sorted(randrange(50) for _ in range(55)))
    print(f"non-intersecting:\t{median(a, b)} vs {my_median(a, b)}")
    print(f"non-intersecting:\t{median(b, a)} vs {my_median(b, a)}")
